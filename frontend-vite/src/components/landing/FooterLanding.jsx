...
const NEWSLETTER_MAILTO =
  'mailto:hola@victoriapecuarios.com' +
...
export default function FooterLanding() {
  ...
  const handleSubscribe = (e) => {
    ...
    window.location.href = `mailto:hola@victoriapecuarios.com?subject=${subject}&body=${body}`;
  };
    ...
    <footer id="nosotros" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="vp-foot-bottom-grid" style={{
            ...
            <div style={{
              ...
              <a href="mailto:hola@victoriapecuarios.com" style={{
                display: 'inline-flex', alignItems: 'center', gap: 8,
                color: 'inherit', textDecoration: 'none',
              }}>
                <FontAwesomeIcon icon={faEnvelope} style={{ fontSize: 10, color: Cur.navy }} />
                hola@victoriapecuarios.com
              </a>
        ...
        <div style={{
          ...
          <div>
            © 2026 Victoria Pecuarios · Ibagué, Tolima · Todos los derechos reservados
          </div>
