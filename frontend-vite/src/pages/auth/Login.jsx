...
const FORGOT_MAILTO =
  ...
  '?subject=' + encodeURIComponent('Recuperar contraseña') +
  '&body=' + encodeURIComponent('Hola, necesito recuperar mi contraseña.\nMi email registrado es: ');
    ...
    <AuthLayout breadcrumb="Iniciar sesión">
      <AuthCard shake={shake}>
        ...
        <h1 style={{
          ...
          Bienvenido <span style={{ fontStyle: 'italic', color: AUTH_C.lime }}>de vuelta</span>
        </h1>
        <p style={{
