// src/App.jsx — Victoria Pets · Tienda Veterinaria
...
function PageFade({ children }) {
  ...
  return (
    <div style={{ opacity: visible ? 1 : 0, transition: "opacity 0.25s ease", minHeight: "100vh" }}>
      {children}
    </div>
  );
}
      ...
      <AuthProvider>
        <CarritoProvider>
          ...
          <Routes>
            ...
            {/* POS cajero */}
            <Route path="/cajero" element={<RutaCajero><PanelCajero /></RutaCajero>} />
