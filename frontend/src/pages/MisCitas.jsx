...
function TarjetaCita({ cita, onCancelar }) {
  ...
  return (
    <>
      ...
      <div className="vp-citas-card" style={{
        background:C.surface,
        border:`1.5px solid ${tieneReagendamiento ? "#fde68a" : C.border}`,
        borderRadius:16, overflow:"hidden", transition:"all 0.2s",
      }}>
        {/* Cabecera */}
        <div className="vp-citas-card-head" style={{ display:"flex", gap:16, padding:"16px 20px", alignItems:"flex-start", flexWrap:"wrap" }}>
          ...
          <div style={{ flex:1, minWidth:180 }}>
            ...
            <p className="vp-citas-vet-name" style={{ margin:"0 0 3px", fontSize:15, fontWeight:800, color:C.text }}>
              Dr(a). {cita.vet_nombre} {cita.vet_apellido}
            </p>
            <p className="vp-citas-vet-spec" style={{ margin:"0 0 6px", fontSize:12, color:C.brand, fontWeight:600 }}>{cita.especialidad}</p>
            <p className="vp-citas-mascota" style={{ margin:0, fontSize:13, color:C.textSec }}>
    ...
    <>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        /* Mobile: cards de citas más compactas */
        @media (max-width: 640px) {
          .vp-citas-page       { padding: 20px 12px 48px !important; }
          .vp-citas-titulo     { font-size: 19px !important; }
          .vp-citas-sub        { font-size: 12px !important; }
          .vp-citas-cta-top    { padding: 8px 14px !important; font-size: 12px !important; }
          .vp-citas-card       { border-radius: 14px !important; }
          .vp-citas-card-head  { padding: 12px 14px !important; gap: 12px !important; }
          .vp-citas-vet-name   { font-size: 14px !important; }
          .vp-citas-vet-spec   { font-size: 11px !important; }
          .vp-citas-mascota    { font-size: 12px !important; }
          .vp-citas-action-btn { padding: 6px 10px !important; font-size: 11px !important; }
        }
      `}</style>
      <div style={{ minHeight:"100vh", background:C.canvas }}>
        ...
        <div className="vp-citas-page" style={{ maxWidth:800, margin:"0 auto", padding:"32px 16px 64px" }}>
          {/* Header */}
          <div className="vp-citas-header" style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:24, flexWrap:"wrap", gap:16 }}>
            ...
            <Link to="/agendar-cita" className="vp-citas-cta-top" style={{
