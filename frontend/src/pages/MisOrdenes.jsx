      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "40px 24px 64px" }}>
        {cargando ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, animation: "fadeUp 0.35s ease" }}>
            ...
            {/* Reglas responsivas locales — comprimen card en móvil */}
            <style>{`
              @media (max-width: 640px) {
                .vp-orden-card        { border-radius: 14px !important; }
                .vp-orden-btn         { padding: 12px 14px !important; gap: 12px !important; }
                .vp-orden-icon        { width: 36px !important; height: 36px !important; border-radius: 10px !important; }
                .vp-orden-icon svg    { font-size: 13px !important; }
                .vp-orden-total       { font-size: 15px !important; }
                .vp-orden-codigo      { font-size: 12px !important; }
                .vp-orden-meta        { font-size: 11px !important; gap: 8px !important; }
              }
            `}</style>
            ...
            {ordenes.map(o => {
              ...
              return (
                <div key={o.id} className="vp-orden-card" style={{
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                        <span className="vp-orden-codigo" style={{ fontFamily: "monospace", fontSize: 13, fontWeight: 800, color: C.brand }}>
                          {o.codigo}
                        </span>
                        <Badge estado={estado} />
                      </div>
                      <div className="vp-orden-meta" style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
